          ...
          <div className={`card text-white mt-4 px-2 ${styles.cardStyling}`}>
              ...
              <ShowImage item={product} url="product/photo" className={`card-img-top`}></ShowImage>
                ...
                <div className={`card-body`}>
                  <p className={styles.cardTitle} style={{fontSize: '25px',fontStyle:'oblique',textAlign:'center',fontWeight:'bold',textDecorationLine:'none',color:'black'}}>{product.name.substring(0, 30)}</p>
                  <div className="">
